    ...
    <div className="flex p-4 w-full border-b border-neutral-50">
      <header className="flex justify-between items-center app-container w-full">
        ...
        <nav className="flex gap-6">
          <Link href="/about" className="btn btn-primary !py-2 !px-3 rounded-lg">Sign In</Link>
          <Link href="/contact" className=" btn btn-primary-border !px-3 !py-2 rounded-lg">Sign Up</Link>
        </nav>
      </header>
    </div>
  );
